...
{
    public class NewSuccessPopUp : MonoBehaviour
    {
        ...
        private NewCardController cardController;

        #region DEFAULT
        public void Init(NewCardController _cardController)
        {
        ...
        public void OnOpen(Action _openPopupCallback)
        {
            ...
            Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.SUCCESS));
        ...
        private void UnlockSeed()
        {
            ...
            Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.ROULETTE));
