...
namespace _PAProjcet
{
    ...
    public class NewCardController : MonoBehaviour
    {
        ...
        [Header("POPUP")]
        [Space(5)]
        //[SerializeField] private NewPointRankingInfoPopup pointRankingInfoPopup;
        [SerializeField] private NewSuccessPopUp successGreenSeedPopup;
        [SerializeField] private NewSuccessPopUp successYellowSeedPopup;
        [SerializeField] private NewSuccessPopUp successRedSeedPopup;
        [SerializeField] private NewSuccessPopUp successGoldenSeedPopup;
        //[SerializeField] private NewFailurePopup failureSeedPopup;
        ...
        private void Start()
        {
            ...
            informationBtn.onClick.AddListener(delegate
            {
                //AudioManager.Instance.PlaySFX(Enums.SFXType.BUTTON_CLICK);
                Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.BUTTON_CLICK));
                Bus<PointInfoBtnAddListenerEvent>.Raise(new PointInfoBtnAddListenerEvent(null));
            });
        ...
        private void StartGameRound()
        {
            ...
            if (curGameRound != 1)
            {
                Bus<OnGameRoundStart>.Raise(new OnGameRoundStart());
            }
        ...
        private void FinishGameRound()
        {
            ...
            else
            {
                ...
                Bus<FailurePopUpAddEventListenerEvent>.Raise(new FailurePopUpAddEventListenerEvent(null));
                Debug.Log("Failure");
            }
        }
        ...
        private void CloseSuccessPopup(NewSuccessPopUp _popup)
        {
        ...
        private void SpawnFinalCardOnContainer(CardView _finalCardView, RectTransform _cardSlotContainer)
        {
            ...
            Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.CARD_DROP));
        }
        #endregion
        ...
        private void DisplayPairCardIndicator(RectTransform _cardContainer)
        {
            ...
            Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.CARD_MATCH));
        ...
        private void DisplaySeedPointVFX(CurrencyRewardVFX _vfx, Transform _spawnPosition, GameObject _target, int _totalSeed)
        {
            if (_totalSeed >= 6)
            {
               //AudioManager.Instance.PlaySFX(Enums.SFXType.POINT_6);
                Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.POINT_6));
            }
            else
            {
                if (_totalSeed > 0)
                {
                    ...
                    Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.POINT_1));
                }
            }
        ...
        private void BeginDragCardAction(CardView _draggedCard)
        {
            ...
            Bus<OnSfxTrigger>.Raise(new OnSfxTrigger(Enums.SFXType.CARD_PICK));
