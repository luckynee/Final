...
namespace PokerSeed.General
{
    public class AudioManager : MonoBehaviour
    {
        ...
        private BGMType curBGMPlaying;
        private AmbienceType curAmbiencePlaying;
        ...
        public void PlayBGM(BGMType bgmScene, bool stop = true)
        {
        ...
        public void PlayCrossFadeBGM(BGMType bgmScene)
        {
            StartCoroutine(CrossFadeAudioRoutine(bgmScene));
        }
        private IEnumerator CrossFadeAudioRoutine(BGMType bgmScene)
        {
            for (int i = 0; i < bgmDataList.Count; i++)
            {
        ...
        #region AMBIENCE
        public void PlayAmbience(AmbienceType ambienceScene, bool stop = true)
        {
        ...
        {
            public AmbienceType AmbienceScene;
            public AudioClip AudioClip;
            public float Volume;
        }
